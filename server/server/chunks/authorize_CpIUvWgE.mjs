...
import { n as handleAuthorizationApproval, t as buildDeniedRedirect } from "./oauth-authorization-oqfbBuMH_CcEn1Ofz.mjs";
//#region node_modules/emdash/dist/astro/routes/api/oauth/authorize.mjs
var authorize_exports = /* @__PURE__ */ __exportAll({
	GET: () => GET,
	POST: () => POST,
	prerender: () => false
});
var CSRF_COOKIE_NAME = "emdash_oauth_csrf";
...
var GET = async ({ url, request, locals }) => {
...
//#endregion
//#region \0virtual:astro:page:node_modules/emdash/dist/astro/routes/api/oauth/authorize@_@mjs
