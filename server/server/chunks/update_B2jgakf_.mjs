...
import { O as handleMarketplaceUpdate } from "./query-Di7DOmPV_CieW2RCL.mjs";
...
import { z } from "zod";
//#region node_modules/emdash/dist/astro/routes/api/admin/plugins/_id_/update.mjs
var update_exports = /* @__PURE__ */ __exportAll({
	POST: () => POST,
	prerender: () => false
});
var updateBodySchema = z.object({
...
//#endregion
//#region \0virtual:astro:page:node_modules/emdash/dist/astro/routes/api/admin/plugins/_id_/update@_@mjs
