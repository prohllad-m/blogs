...
import { F as handleOrphanedTableList } from "./query-Di7DOmPV_CieW2RCL.mjs";
...
//#region node_modules/emdash/dist/astro/routes/api/schema/orphans/index.mjs
var orphans_exports = /* @__PURE__ */ __exportAll({
	GET: () => GET,
	prerender: () => false
});
var GET = async ({ locals }) => {
	...
	return unwrapResult(await handleOrphanedTableList(emdash.db));
};
//#endregion
//#region \0virtual:astro:page:node_modules/emdash/dist/astro/routes/api/schema/orphans/index@_@mjs
var page = () => orphans_exports;
//#endregion
export { page };
