//#region node_modules/emdash/dist/errors-DtEXIQQV.mjs
/**
...
function mapErrorStatus(code) {
	switch (code) {
		...
		case ErrorCode.REORDER_MISMATCH: return 400;
		...
		case ErrorCode.ENV_INCOMPATIBLE: return 409;
		...
		case ErrorCode.COLLECTION_SCHEMA_MISMATCH: return 500;
