import { i as setRequestCacheEntry, n as peekRequestCache, t as clearRequestCacheEntry } from "./request-cache_CwLBsNi5.mjs";
import { a as EmDashValidationError, c as decodeCursor, i as getDb, l as encodeCursor } from "./loader_H3QLxJZA.mjs";
import { t as validateIdentifier } from "./validate_DjLzGa7z.mjs";
import { a as chunks, l as listTablesLike } from "./resolve_tHc8MOuV.mjs";
import { i as isMissingTableError } from "./config_xGs4R7N0.mjs";
import { a as invalidateBylineObjectCache, o as invalidateCollectionCache } from "./object-cache_BOlPl5ud.mjs";
import { o as withTransaction } from "./types_BeH4aj60.mjs";
import { t as getBylineFieldDefs } from "./field-defs-cache_Js2Tl-rc.mjs";
import { sql } from "kysely";
import { ulid } from "ulidx";
//#region node_modules/emdash/src/database/repositories/byline.ts
	...
	async applyCustomFieldWritesInTrx(trx, bylineId, translationGroup, writes, now) {
		...
		for (const { field, value } of writes) {
			...
			if (field.translatable) {
				if (value === null) await trx.deleteFrom("_emdash_byline_field_values").where("byline_id", "=", bylineId).where("field_id", "=", field.id).execute();
				else {
...
//#endregion
//#region node_modules/emdash/src/bylines/index.ts
/**
