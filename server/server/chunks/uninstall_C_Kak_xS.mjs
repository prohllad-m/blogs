...
import { D as handleMarketplaceUninstall } from "./query-Di7DOmPV_CieW2RCL.mjs";
...
import { z } from "zod";
//#region node_modules/emdash/dist/astro/routes/api/admin/plugins/_id_/uninstall.mjs
var uninstall_exports = /* @__PURE__ */ __exportAll({
	POST: () => POST,
	prerender: () => false
});
var uninstallBodySchema = z.object({ deleteData: z.boolean().optional() });
...
//#endregion
//#region \0virtual:astro:page:node_modules/emdash/dist/astro/routes/api/admin/plugins/_id_/uninstall@_@mjs
var page = () => uninstall_exports;
//#endregion
export { page };
